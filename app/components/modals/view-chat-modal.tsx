             ...
             <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
                ...
                {/* <ScrollArea className="px-6"> */}
                    <section className="space-y-5 border rounded p-3">
                        ...
                        <Separator />
                        {/* <div className="grid grid-cols-2 gap-x-6 gap-y-4 p-4 text-sm text-gray-700 bg-white rounded-md shadow-sm"> */}
                        <div className="grid grid-cols-2 gap-x-6 space-y-2 text-sm text-gray-700">
                            ...
                            <p><strong>Chat Transcript:</strong> {chat?.chatTranscript || "N/A"}</p>
